...
class AgentHelper(object):
    ...
    def __init__(self, agent_config, network, service, sim_config, seed, episodes, weights, verbose, DATETIME, test, append_test, sim_seed, gen_scenario, episode_steps=200):
