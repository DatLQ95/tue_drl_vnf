...
parallel rlsp :::: scripts/agent_config_files.txt :::: scripts/network_files.txt :::: scripts/service_files.txt :::: scripts/config_files.txt :::: scripts/service_requirement.txt ::: "400" ::: "--seed" :::: scripts/10seeds.txt ::: "--append-test"
